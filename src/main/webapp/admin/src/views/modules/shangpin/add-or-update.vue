  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" v-if="ruleForm.shangpinmingcheng" label="商品名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="商品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="球队" prop="qiudui">
          <el-select v-model="ruleForm.qiudui" placeholder="请选择球队">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qiudui" label="球队" prop="qiudui">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fenlei" label="分类" prop="fenlei">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.guige" label="规格" prop="guige">
              <el-input v-model="ruleForm.guige" 
